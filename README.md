#### A small exercise Dotnet application made for a school project.
...
#### The backend has been written with EFCore and for the database I've used a locally hosted MariaDB instance. As for the frontend, it has been written with Blazor.
# 
Notes: 
